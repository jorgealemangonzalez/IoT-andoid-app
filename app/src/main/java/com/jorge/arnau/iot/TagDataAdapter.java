...
public class TagDataAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view ==null){
            ...
            holder.remainingTimeView = (TextView) view.findViewById(R.id.remaining_time);
            view.setTag(holder);
        ...
        if (record.RFID != null) {
            ...
            if (averageEatingTime == null || remainingTime == null) {
                ...
                holder.remainingTimeView.setText("N/A");
            } else {
                int progress = 100;
                ...
                holder.remainingTimeView.setText(Math.round(remainingTime) + " s");
            }
        }
